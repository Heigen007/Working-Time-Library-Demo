...
<script>
import FindWorkingPeriod from 'work-time-library/FindWorkingTimeAdd'
...
export default {
  ...
  methods: {
    computeTime() {
        this.StartDate = `${this.time.getFullYear()}-${(this.time.getMonth() + 1) > 9 ? (this.time.getMonth() + 1) : '0' + (this.time.getMonth() + 1) }-${this.time.getDate() > 9 ? this.time.getDate() : '0' + this.time.getDate()}T${this.time.getHours() > 9 ? this.time.getHours() : '0' + this.time.getHours()}:${this.time.getMinutes() > 9?this.time.getMinutes():'0'+this.time.getMinutes()}:${this.time.getSeconds() > 9?this.time.getSeconds():'0'+this.time.getSeconds()}`
      ...
      var a = FindWorkingPeriod(this.StartDate, this.segmentsCopy, Number(this.AdditionalSecs))
      Swal.fire(
        'Success!',
        `The deadline is: ${a}`,
        'success'
